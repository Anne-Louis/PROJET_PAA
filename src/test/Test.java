...
public class Test {
    public static void main (String[] args){
        ...
        Maison msn3 = new Maison("maison3",NiveauConsommation.NORMAL);
        Maison msn4 = new Maison("maison4",NiveauConsommation.FORTE);
        Maison msn5 = new Maison("maison5",NiveauConsommation.FORTE);
        Maison msn6 = new Maison("maison6",NiveauConsommation.NORMAL);
        Maison msn7 = new Maison("maison7",NiveauConsommation.NORMAL);
